...
public class Student_2 extends Person_2{
    ...
    public Student_2(String sutdenID, int academic_year, float gba, float social_actvities, String name, char gender, int birth_year) {
    ...
    public int compareTo(Student_2 arg0) {
